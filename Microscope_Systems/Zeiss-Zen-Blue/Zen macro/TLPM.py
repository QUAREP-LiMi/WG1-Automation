...
class TLPM:
	...
	def __init__(self):
		if sizeof(c_voidp) == 4:
			self.dll = cdll.LoadLibrary(os.path.dirname(__file__)+"\TLPM_64.dll")
		else:
			self.dll = cdll.LoadLibrary(os.path.dirname(__file__)+"\TLPM_64.dll")
	...
	def writeRegister(self, reg, value):
		...
		Args:
			...
			STATUS BYTE bits (see IEEE488.2-1992 Sec.11.2)
			...
			STANDARD EVENT STATUS REGISTER bits (see IEEE488.2-1992 Sec.11.5.1)
			...
			QUESTIONABLE STATUS REGISTER bits (see SCPI 99.0 Sec.9)
			...
			OPERATION STATUS REGISTER bits (see SCPI 99.0 Sec.9)
	...
	def readRegister(self, reg, value):
		...
		Args:
			...
			STATUS BYTE bits (see IEEE488.2-1992 Sec11.2)
			...
			STANDARD EVENT STATUS REGISTER bits (see IEEE488.2-1992 Sec11.5.1)
			...
			QUESTIONABLE STATUS REGISTER bits (see SCPI 99.0 Sec9)
			...
			OPERATION STATUS REGISTER bits (see SCPI 99.0 Sec9)
